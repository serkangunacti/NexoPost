          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="glass p-6 rounded-3xl border border-white/5">
              <div className="flex items-center gap-3 text-neutral-400 font-semibold mb-4">
                <Users className="w-5 h-5 text-violet-400" /> Total Audience
              </div>
              <div className="text-3xl font-bold text-white mb-2">1,248,849</div>
            ...
            <div className="glass p-6 rounded-3xl border border-white/5">
              <div className="flex items-center gap-3 text-neutral-400 font-semibold mb-4">
                <Eye className="w-5 h-5 text-sky-400" /> Content Impressions
              </div>
              <div className="text-3xl font-bold text-white mb-2">5,892,100</div>
              <div className="text-sm font-semibold text-emerald-400 flex items-center gap-1 bg-emerald-400/10 w-fit px-2 py-1 rounded-md">
                <TrendingUp className="w-3 h-3" /> +34.2% this month
              </div>
            </div>

            <div className="glass p-6 rounded-3xl border border-white/5">
              <div className="flex items-center gap-3 text-neutral-400 font-semibold mb-4">
                <BarChart3 className="w-5 h-5 text-pink-400" /> Profile Engagement
              </div>
              <div className="text-3xl font-bold text-white mb-2">482,911</div>
              <div className="text-sm font-semibold text-emerald-400 flex items-center gap-1 bg-emerald-400/10 w-fit px-2 py-1 rounded-md">
                <TrendingUp className="w-3 h-3" /> +8.1% this month
              </div>
            </div>
          </div>
